...
import { NavBar , Flex , ActivityIndicator, Popover, Icon} from 'antd-mobile';
    ...
    render(){
        ...
        return(
            <div className="wx_home">
                ...
                >
                    <div style={{height: '100%',padding: '0 0.3rem',marginRight: '-0.3rem',display: 'flex',alignItems: 'center',}}><Icon style={{fontSize:'18px'}} type="user" /></div>
                </Popover>
                }>活力圈</NavBar>
